...
function landscapeTextBoxfunc({
  width,
  height,
  fabric,
  params,
}: CustomFabricFunctionArgs): CustomFabricFunctionCallbacks {
  return {
    async onRender(progress, canvas) {
      canvas.backgroundColor = "hsl(33, 100%, 50%)";

      const backgroundParallelogram = new fabric.Polygon(
        [
          { x: 40, y: 0 },
          { x: 1540, y: 0 },
          { x: 1500, y: 210 },
      ...
      backgroundParallelogram.left =
        (width - backgroundParallelogram.width) / 2;
      backgroundParallelogram.top =
        height - backgroundParallelogram.height - 80;
      canvas.add(backgroundParallelogram);

      const bottomParallelogram = new fabric.Polygon(
        [
          { x: 20, y: 0 },
          { x: 570, y: 0 },
          { x: 550, y: 50 },
      ...
      const topLeftParallelogram = new fabric.Polygon(
        [
          { x: 15, y: 0 },
          { x: 295, y: 0 },
          { x: 280, y: 45 },
      ...
      const topLeftSmallParallelogram = new fabric.Polygon(
        [
          { x: 15, y: 0 },
          { x: 23, y: 0 },
          { x: 8, y: 45 },
      ...
      topLeftSmallParallelogram.left =
        topLeftParallelogram.left + topLeftParallelogram.width - 12;
      ...
      const topRightParallelogram = new fabric.Polygon(
        [
          { x: 15, y: 0 },
          { x: 295, y: 0 },
          { x: 280, y: 75 },
      ...
      const RedTopRightParallelogram = new fabric.Polygon(
        [
          { x: 15, y: 0 },
          { x: 245, y: 0 },
          { x: 230, y: 75 },
      ...
      RedTopRightParallelogram.left =
        width - RedTopRightParallelogram.width - 150;
      RedTopRightParallelogram.top =
        height - RedTopRightParallelogram.height - 255;
      canvas.add(RedTopRightParallelogram);

      const RedTopRightTriangle = new fabric.Polygon(
        [
          { x: 5, y: 0 },
          { x: 40, y: 0 },
          { x: 0, y: 40 },
      ...
      RedTopRightTriangle.top =
        RedTopRightParallelogram.top + RedTopRightParallelogram.height;
      canvas.add(RedTopRightTriangle);

      const latestTextBox = new fabric.Textbox("每日全球", {
        fill: "white",
        fontWeight: "bold",
        fontSize: 55,
      ...
      const newsTextBox = new fabric.Textbox("热点新闻", {
        fill: "white",
        fontWeight: "bold",
        fontSize: 45,
        fontFamily: "Microsoft Yahei UI",
      ...
      const newsTitle = new fabric.Textbox(params.title, {
        fill: "#41318E",
        fontWeight: "bold",
        fontSize: 35,
        fontFamily: "Microsoft Yahei UI",
      ...
      const contentTitle = new fabric.Textbox(params.content, {
        fill: "#41318E",
        fontSize: 30,
        fontFamily: "Microsoft Yahei UI",
        width: 1160,
...
async function landscapeAvatarfunc({
  image,
  fabric,
}: VideoPostProcessingFunctionArgs): Promise<void> {
  const config = {
    height: 772,
    width: 772,
    x: 159,
  ...
  return {
    async onRender(progress, canvas) {
      ...
      if (contentTextBox.top + contentTextBox.height + 20 > height) {
        topDifference =
          contentTextBox.top + contentTextBox.height + 20 - height;
      }
...
async function portraitAvatarfunc({
  image,
  fabric,
}: VideoPostProcessingFunctionArgs): Promise<void> {
  const config = {
